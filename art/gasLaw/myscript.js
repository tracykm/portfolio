		...
		function addParticles(num, img){
			for(i=0;i<num;i++){
				if(img=='particleB.png'){
					...
					$('#container').append('<img src="img/'+img+'" class="electron B" angle=-10 speed='+speed+' xPixel=0 yPixel=0>');
				}else{
					var speed = Math.random()*2+2;
					$('#container').append('<img src="img/'+img+'" class="electron A" angle=-10 speed='+speed+' xPixel=0 yPixel=0>');
				}
